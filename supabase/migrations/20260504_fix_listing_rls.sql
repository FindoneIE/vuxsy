...
drop policy if exists "Listings are publicly readable when active" on public.listings;
drop policy if exists "Listings are readable by owner" on public.listings;
drop policy if exists "Listings can be created by owner" on public.listings;
drop policy if exists "Listings can be updated by owner" on public.listings;
drop policy if exists "Listings can be deleted by owner" on public.listings;
