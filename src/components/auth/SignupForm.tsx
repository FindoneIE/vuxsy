...
// SignupForm receives `redirect` as a prop instead of calling
// useSearchParams(). See LoginForm for rationale — eliminates the
// CSR-bailout Suspense boundary on the /signup route.
